    ...
    <div>
        <div className="preloader">
                        ...
                        <div className="office-slider">
                            <div className="swiper-wrapper">
                                <div className="swiper-slide">
                                    <figure className="reveal-effect masker wow"> <img src="./assets/images/office01.jpg" alt="Image"/>
                                    <figcaption>
            ...
            <section className="works">
                <ul>
                    <li>
                        <figure className="reveal-effect masker wow"> <a href="./assets/images/works01.jpg" data-fancybox><img src="./assets/images/works01.jpg" alt="Image"/></a> </figure>
                        <div className="caption wow" data-splitting>
                        <h3>Darkness Vehicle</h3>
                        <small>DIGITAL, PRINT, DEVELOPMENT</small> </div>
                    </li>
                    <li>
                        <figure className="reveal-effect masker wow"> <a href="./assets/images/works02.jpg" data-fancybox><img src="./assets/images/works02.jpg" alt="Image"/></a> </figure>
                        <div className="caption wow" data-splitting>
                        <h3>Goddes Cover Art</h3>
                        <small>PRINT, DIGITAL, DEVELOPMENT</small></div>
                    </li>
                    <li>
                        <figure className="reveal-effect masker wow"> <a href="./assets/images/works03.jpg" data-fancybox><img src="./assets/images/works03.jpg" alt="Image"/></a> </figure>
                        <div className="caption wow" data-splitting>
                        <h3>Hard Employee</h3>
                        <small>WEB, DIGITAL, DEVELOPMENT</small> </div>
                    </li>
                    <li>
                        <figure className="reveal-effect masker wow"> <a href="./assets/images/works04.jpg" data-fancybox><img src="./assets/images/works04.jpg" alt="Image"/></a> </figure>
                        <div className="caption wow" data-splitting>
                        <h3>Sweet Berry Pie</h3>
                        <small>DIGITAL, PRINT, DEVELOPMENT</small> </div>
                    </li>
                    <li>
                        <figure className="reveal-effect masker wow"> <a href="./assets/images/works05.jpg" data-fancybox><img src="./assets/images/works05.jpg" alt="Image"/></a> </figure>
                        <div className="caption wow" data-splitting>
                        <h3>King of Roosters</h3>
                        <small>PRINT, DIGITAL, DEVELOPMENT</small> </div>
                    </li>
                    <li>
                        <figure className="reveal-effect masker wow"> <a href="./assets/images/works06.jpg" data-fancybox><img src="./assets/images/works06.jpg" alt="Image"/> </a></figure>
                        <div className="caption wow" data-splitting>
                        <h3>Primero  Car</h3>
                        <small>WEB, DIGITAL, DEVELOPMENT</small> </div>
                    </li>
